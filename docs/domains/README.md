...
| --- | --- | --- |
| `web-saas` | Doco-CD manages repository-defined application deployment. | `setup-Doco-CD.yaml` |
...
| `open-platform` | Gitea, Vault, Zitadel, Grafana, VictoriaMetrics, and related infrastructure are installed through Playbook roles. | `deploy_infra_platform` workflow job |
